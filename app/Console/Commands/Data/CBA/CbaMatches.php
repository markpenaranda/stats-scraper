...
use App\Services\CBA\Sina\Match as CbaMatch;
use App\Match;
use App\Team;

class CbaMatches extends Command
{
    /**
     ...
     * @var string
     n
     */
    protected $description = 'Cron CBA Games';
            ...
            foreach ($fixtures as $item) {
                ...
                if(count($match->teams) == 0) {
                    foreach($item['teams'] as $remarks => $value) {
                        $team = Team::where('name', $value)->where('league', 'cba')->first();
